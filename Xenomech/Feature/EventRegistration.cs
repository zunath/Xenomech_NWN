...
namespace Xenomech.Feature
{
    public class EventRegistration
    {
        ...
        private static void HookApplicationEvents()
        {
            ...
            EventsPlugin.SubscribeEvent("XM_ITEM_EQUIP_VALID_BEFORE", "item_eqp_bef");
            EventsPlugin.SubscribeEvent("XM_BUY_PERK", "xm_buy_perk");
            EventsPlugin.SubscribeEvent("XM_GAIN_SKILL_POINT", "xm_gain_skill");
            EventsPlugin.SubscribeEvent("XM_COMPLETE_QUEST", "xm_comp_qst");
            EventsPlugin.SubscribeEvent("XM_CACHE_SKILLS_LOADED", "xm_skl_cache");
            EventsPlugin.SubscribeEvent("XM_EXAMINE_OBJECT_BEFORE", "examine_bef");
        }
        ...
        public static void ResetExamineDescription()
        {
            ...
            EventsPlugin.SignalEvent("XM_EXAMINE_OBJECT_BEFORE", OBJECT_SELF);
        }
